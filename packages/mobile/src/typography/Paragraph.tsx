...
import {Breaker, Typo, TypoProps, Stub, Box} from '@qiwi/pijma-core'
...
export const Paragraph: FunctionComponent<ParagraphProps> = ({size = 'm', bold = false, compact = false, color = 'default', transform, align, stubLines = [75, 88, 62], stub, children}) => (
  stub ? (
    <Box>
