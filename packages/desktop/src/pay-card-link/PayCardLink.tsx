...
import {Box, Card, Flex, LinkControl, LinkControlProps, Lnk, Image} from '@qiwi/pijma-core'

import {Text} from '../typography'

export interface PayCardLinkProps {
  srcImg: string
  text: string
  tabIndex?: number
...
const BoxLnk = Box.withComponent(Lnk)

export const PayCardLink: FC<PayCardLinkProps> = (props) => (
  <LinkControl
