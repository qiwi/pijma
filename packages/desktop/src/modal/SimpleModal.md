Рекомендуемый размер заголовка — [H2](#/Компоненты/Heading), основной текст — [Body M]() 500 (Normal).

Размещайте внутри модальных окон [Brand Button](#/Компоненты/Button) и [Simple Button](#/Компоненты/Button)в размере Normal.
