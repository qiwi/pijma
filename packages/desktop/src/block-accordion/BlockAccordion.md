Меню-аккордеон — это вертикальный список. Он состоит из свернутых элементов, у которых видны только заголовки. Каждый элемент можно развернуть, чтобы посмотреть содержимое.
